...
field in the v0.3 direct-Agent profile. It binds the statement to the
...
Gateway-routed mode is not part of the v0.3 core profile. Gateway
...
\texttt{docs/gateway-routed-profile.md}. It should be treated as
post-v0.3 design work until route assertions, tenant partitioning,
